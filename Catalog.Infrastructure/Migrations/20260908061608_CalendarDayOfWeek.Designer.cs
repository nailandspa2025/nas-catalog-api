...
namespace Catalog.Infrastructure.Migrations
{
    ...
    [Migration("20260908061608_CalendarDayOfWeek")]
    partial class CalendarDayOfWeek
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Catalog.Domain.Entities.AppDeepLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Catalog.Domain.Entities.CalendarDayOfWeek", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Catalog.Domain.Entities.PayPalConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PayPalConfig");
                });

            modelBuilder.Entity("Catalog.Domain.Entities.PaymentProvider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Catalog.Domain.Entities.PaymentProviderSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Catalog.Domain.Entities.ReviewStoreFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Catalog.Domain.Entities.StoreBio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Catalog.Domain.Entities.StoreWorkingDay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Catalog.Domain.Entities.UserStoreDeepLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Catalog.Domain.Entities.PayPalConfig", b =>
                {
                    b.HasOne("Catalog.Domain.Entities.Store", "Store")
                        .WithOne("PayPalConfig")
                        .HasForeignKey("Catalog.Domain.Entities.PayPalConfig", "StoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Catalog.Domain.Entities.PaymentProviderSetting", b =>
                {
                    b.HasOne("Catalog.Domain.Entities.PaymentProvider", "PaymentProvider")
                        .WithMany("Settings")
            ...
            modelBuilder.Entity("Catalog.Domain.Entities.StoreBio", b =>
                {
                    b.HasOne("Catalog.Domain.Entities.Store", "Store")
                        .WithOne("StoreBio")
                        .HasForeignKey("Catalog.Domain.Entities.StoreBio", "StoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Catalog.Domain.Entities.Store", b =>
                {
                    ...
                    b.Navigation("StoreBio");

                    b.Navigation("StoreWorkingDays");

                    b.Navigation("UserStoreDeepLinks");
